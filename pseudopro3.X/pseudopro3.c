...
//variables
//124
unsigned char potbang0, potbang1, potbang2, potbang3;
...
unsigned char numresets(unsigned char potbang){
    ...
    else if (potbang > 19 && potbang <= 40)
    {
        tmr0resets =  3;
    }
    else if (potbang > 40 && potbang <= 61 )
    {
        tmr0resets =  5;
    }
    else if (potbang > 61 && potbang <= 82)
    {
        tmr0resets =  6;
    }
    else if (potbang > 82 && potbang <= 103 )
    {
        tmr0resets =  7;
    }
    else if (potbang > 103 && potbang <= 131)
    {
        tmr0resets =  8;
    }
    else if (potbang > 131 && potbang <= 152)
    {
        tmr0resets =  9;
    }
    else if (potbang > 152 &&  potbang <= 173)
    {
        tmr0resets =  10;
    }
    else if (potbang > 173 && potbang <= 194)
    {
        tmr0resets =  11;
    }
    else if ( potbang > 194 && potbang <= 215)
    {
        tmr0resets =  12;
    }
