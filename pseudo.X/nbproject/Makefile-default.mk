...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/pseudo.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
POSSIBLE_DEPFILES=${OBJECTDIR}/pseudo.o.d
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/pseudo.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/pseudo.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_LD} -mcpu=PIC16F887 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o dist/${CND_CONF}/${IMAGE_TYPE}/pseudo.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
