...
loop:
    ...
    btfss ((INTCON) and 07Fh), 2 ;cuando se activa el Bit de bandera de overflow de tmr0, se salta la siguiente instruccion
...
config_reloj:
    ...
    bcf ((OSCCON) and 07Fh), 6 ; 001, Frecuencia de 125kHz
...
config_io:
    ...
    movwf TRISB ;los pines deseados en el puerto A (((PORTA) and 07Fh), 0, ((PORTA) and 07Fh), 1, ((PORTA) and 07Fh), 2, ((PORTA) and 07Fh), 3 y ((PORTA) and 07Fh), 4)
...
config_tmr0:
    ...
    bsf ((OPTION_REG) and 07Fh), 2 ; 111, que es 1:256
