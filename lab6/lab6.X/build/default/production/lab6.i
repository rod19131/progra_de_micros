...
isr:
    ...
    btfsc ((PIR1) and 07Fh), 0 ;chequear la bandera de la interrupción del tmr1
    call int_tmr1 ;llamar a la subrutina del tmr1
    btfsc ((PIR1) and 07Fh), 1 ;chequear la bandera de la interrupción del tmr2
...
rst_tmr1:
    ...
    movwf TMR1H
    bcf ((PIR1) and 07Fh), 0 ;se limpia la bandera de overflow de tmr1
    return
