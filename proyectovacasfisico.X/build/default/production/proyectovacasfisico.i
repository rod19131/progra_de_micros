...
# 2 "<built-in>" 2
# 1 "proyectovacasfisico.c" 2
# 12 "proyectovacasfisico.c"
...
void __attribute__((picinterrupt(("")))) isr (void){
    ...
    if (ADIF == 1) {
        ...
        switch (ADCON0bits.CHS){
            ...
            case 2:
                valservo0 = mapear(ADRESH);
                ADCON0bits.CHS = 3;
                break;

            case 3:
                valservo1 = mapear(ADRESH);
                ADCON0bits.CHS = 4;
                break;

            case 4:
                valservo2 = mapear(ADRESH);
                ADCON0bits.CHS = 5;
                break;

            case 5:
                valservo3 = mapear(ADRESH);
                ADCON0bits.CHS = 0;
                break;
        }
    ...
    if (T0IF == 1){
        ...
        RD0 = 1;
        _delay((unsigned long)((465)*(8000000/4000000.0)));
        while (contservo0 <= valservo0){
            contservo0++;
        }
        RD0=0;
        ...
        RD2 = 1;
        _delay((unsigned long)((465)*(8000000/4000000.0)));
        while (contservo2 <= valservo2){
            contservo2++;
        }
        RD2=0;
        RD3 = 1;
        _delay((unsigned long)((465)*(8000000/4000000.0)));
        while (contservo3 <= valservo3){
            contservo3++;
        }
        RD3=0;
    }
