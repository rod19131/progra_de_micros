...
unsigned char numresets(unsigned char ValorPot)
{
    if (ValorPot <19)
    {
        return 2;
...
void __attribute__((picinterrupt(("")))) isr(void){
    ...
    if (ADIF == 1) {
        ...
        switch (ADCON0bits.CHS){
            ...
            case 2:
                potbang0 = numresets(ADRESH+124);
                ADCON0bits.CHS = 3;
                break;

            case 3:
                potbang1 = numresets(ADRESH+124);
                ADCON0bits.CHS = 4;
                break;

            case 4:
                potbang2 = numresets(ADRESH+124);
                ADCON0bits.CHS = 5;
                break;

            case 5:
                potbang3 = numresets(ADRESH+124);
                ADCON0bits.CHS = 0;
                break;
        }
